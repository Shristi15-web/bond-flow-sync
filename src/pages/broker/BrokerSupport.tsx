...
function loadTickets(): SupportTicket[] {
  try {
    const stored = localStorage.getItem(BROKER_TICKETS_STORAGE_KEY);
...
function saveTickets(tickets: SupportTicket[]): void {
  localStorage.setItem(BROKER_TICKETS_STORAGE_KEY, JSON.stringify(tickets));
}
  ...
  return (
    <DashboardLayout title="Lister Support" subtitle="Get help with listings, compliance, or technical issues">
      <div className="max-w-4xl mx-auto">
        ...
        {/* New Request Form */}
        {view === 'form' && (
          <Card className="p-8 bg-gradient-to-br from-card/80 to-card/40 border-border/50 backdrop-blur-sm animate-fade-in">
              ...
              <div className="space-y-2">
                ...
                >
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="investor">Investor Management</SelectItem>
                    <SelectItem value="settlement">Settlement Issues</SelectItem>
